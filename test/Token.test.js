...
contract('Token', ([deployer, receiver, exchange]) => {
    const name = 'Gunther Token'
    const symbol = 'GUNTHER'
    const decimals = '18'
    ...
    describe('burn tokens', () => {
        ...
        describe('success', () => {
            beforeEach(async () => {
                ...
                console.log("totalSupply before burn", totalSupply.toString());
                result = await token.burn(amount, {from: deployer})
            })

            it('transfers token balances', async () => {
                totalSupply = await token.totalSupply()
                console.log("totalSupply after burn", totalSupply.toString());
            })
